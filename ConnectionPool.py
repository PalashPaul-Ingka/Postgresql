...
def Connection(max_conn=5, expiration=60, disable_pooling=False, pool_manager=SimpleConnectionPool, **kwargs):
    config = None
    dsn = kwargs.get('dsn', os.environ.get('DATABASE_DSN'))
    db_url = kwargs.get('db_url', os.environ.get('DATABASE_URL'))
    sslrootcert = kwargs.get('sslrootcert', os.environ.get('sslrootcert'))
    sslcert = kwargs.get('sslcert', os.environ.get('sslcert'))
    sslkey = kwargs.get('sslkey', os.environ.get('sslkey'))
